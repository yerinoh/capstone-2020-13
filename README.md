...
**오픈소스 디자인 사이트의 다국적 화상회의 서비스 개발**
  ...
  <img height="150" src="./Image/opensrcdesign.png"/>
  ...
  <img height="300" src="./Image/5G.png">
  
  추가적으로, 화상회의를 하는데 있어 서로 다른 국적을 가진 경우 언어의 제약이 존재한다. 
  상대방이 말할 때 자신의 언어로 번역하여 상대방이 어떤 말을 하였는지 확인할 수 있는 기능을 추가하여
  다국적 협업이 가능할 수 있는 화상회의 서비스를 개발하고자 한다.
